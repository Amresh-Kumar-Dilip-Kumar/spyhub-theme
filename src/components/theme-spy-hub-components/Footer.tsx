            ...
            <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
                            Empowering you with secure insights and tools to stay informed.
                        </p>
                        ...
                        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
                            <li>
                                <a
                                    ...
                                    rel="noreferrer"
                                    target="_blank"
                                    className="text-black transition hover:text-red-700/75"
                                >
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-gray-700">spyhub.in@gmail.com</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-gray-700">7879109854</span>
                                    </a>
                                </li>
                                ...
                                >
                                    ...
                                    <address className="-mt-0.5 flex-1 not-italic text-gray-700">
                                        sharda chowk raipur chhattisgarh
                                    </address>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="mt-12 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        ...
                        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 SpyHub</p>
                    </div>
                </div>
            </div>
        </footer>
